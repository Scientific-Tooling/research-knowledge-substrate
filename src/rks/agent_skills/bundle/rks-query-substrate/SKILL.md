...
Prefer `rks output ...` commands when the user expects:
...
If the user instead needs raw graph inspection or claim-by-claim validation, stay with the lower-level query commands.
